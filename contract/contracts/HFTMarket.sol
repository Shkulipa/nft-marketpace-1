...
contract NFTMarket is ERC721URIStorage, Ownable {
  ...
  // if price is 0 && tokenURI is an empty string => NFT was transfered(either bought, or the listing was canceled)
  event NFTTransfer(uint256 tokenID, address from, address to, string tokenURI, uint256 price);

  constructor() ERC721("About NFTs", "ANFT") {}

  function createdNFT(string calldata tokenURI) public {
    _tokenIds.increment();
  ...
  function buyNFT(uint256 tokenID) public payable {
    ...
    require(msg.value == listing.price, "NFTMarket: inncorrect price");
